...
% You can specify more than one co-supervisor, separating each one with a comma.
...
\matriculationPrefix{matr.}  % specify prefix for matriculation number
...
\include{Chapters/Preliminaries_and_Sota}
